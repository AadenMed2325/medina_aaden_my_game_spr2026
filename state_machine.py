...
# more efficient way to check for errors
# clean up print function comments
is_log_enabled: bool = False

# new class to store all of the states
class State():
    def __init__(self):
        pass
    def enter(self):
...
# this class is for state transition
class StateMachine():
    def __init__(self):
    ...
    def start_machine(self, init_states = [State]):
        ...
        # give us only the most recent state
    ...
    # transitions: change if yes, notify if none
    def update(self):
    ...
    def transition(self, new_state_name):
        ...
        # exit the old state, enter the new one
